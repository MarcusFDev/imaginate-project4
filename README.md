...
[Imaginate](https://github.com/MarcusFDev/imaginate-project4). Stories for readers, fueled by the power of imagination.  With a modern user-driven design, Imaginate aims to be the new core place to write, store and share a individuals imagination online.
...
- To have the power to edit & delete their story.
...
- Ability to customize a user profile.
- Ability to Follow other user profiles.
- Ability to block other users.
- Ability to disable comments on a story.
- Ability to delete comments as the story owner.
...
[Imaginate]() is a both frontend & backend project utilizing the Django framework to build a expandable and modern user-driven website. 

To experience the project [Heroku]() was used to host Imaginate via their website platform. 
...
To view my Heroku deployment of Imaginate please follow this [link]().
